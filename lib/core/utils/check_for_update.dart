  ...
  if (shouldUpdate) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)), // Softer corners
        title: Row(
          children: [
            Icon(Icons.system_update_alt, color: Theme.of(context).primaryColor, size: 28), // Engaging icon
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min, // Prevents content from taking full height
          ...
          children: [
            ...
            Text(
              context.tr('whats_new:'), // Engaging section for potential release notes
        ...
        actions: [
          TextButton(
            ...
            style: TextButton.styleFrom(
              ...
              backgroundColor: Theme.of(context).primaryColor, // Primary color for action button
            ),
            child: Text(
          ...
          TextButton(
            onPressed: () => Navigator.of(ctx).pop(), // Allows users to dismiss if not critical
            child: Text(
